	...
	return (
		<section className="relative min-h-screen flex items-center justify-center pt-16 sm:pt-20 px-4 sm:px-g lg:px-8 overflow-hidden">
			<div
				...
				style={{
					background: `radial-gradient(circle at ${mousePositon.x}px ${mousePositon.y}px, rgba(7, 7, 8, 0.8), transparent 60%)`,
				}}
			/>
			<div className="absolute top-20 left-4 sm:left-10 w-48 sm:w-72 h-48 sm:h-72 bg-slate-800/40 rounded-full blur-3xl animate-pulse" />
			<div className="absolute bottom-20 right-4 sm:right-10 w-64 sm:w-96 h-64 bg-slate-500/40 rounded-full blur-3xl animate-pulse delay-1000" />
